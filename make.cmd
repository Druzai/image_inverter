@ECHO OFF
python -m nuitka --standalone --enable-plugin=tk-inter --windows-icon-from-ico=icon.ico ^
 --disable-console --windows-product-name="Image Inverter" --windows-file-version=0.2 ^
